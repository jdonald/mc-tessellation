...
// Geometry Shader for Entities - Tessellation for Mobs/Player
// Adapts the iterative stack-based tessellation for dynamic entities
...
void main() {
    ...
    while (stackTop > 0) {
        ...
        // Apply displacement
        // Keep it modest (0.05) to avoid breaking entity models too much
